...
<body>
    <div class="login-page container">
        <div class="login-page__site-branding page-site-branding">
            <a href="../../index.php">
        ...
        <div class="login-page__form">
            ...
            <form action="../../controllers/user/login.php" method="post">
                <?php if (isset($_SESSION['login_error'])) : ?>
                    <div class="login-error alert-box alert-box--error">
        ...
        <div class="login-page__signup">
            <p>¿No tienes cuenta? <a href="registration_form.php">Regístrate</a></p>
        </div>
    </div>
