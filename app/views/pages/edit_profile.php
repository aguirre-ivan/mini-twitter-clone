        ...
        <div class="edit-profile-form">
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="edit-profile-form__item-container">
                    ...
                    <input class="twitter-input" type="text" id="name" value="<?= $page_data['user_data']['name'] ?>" name="name">
                </div>

                <div class="edit-profile-form__item-container">
                    <label for="location">Ubicación</label>
                    <input class="twitter-input" type="text" id="location" value="<?= $page_data['user_data']['location'] ?>" name="location">
                </div>

                <div class="edit-profile-form__item-container">
                    <label for="headerImage">Foto de portada</label>
                    <input class="twitter-input" type="file" id="headerImage" name="headerImage">
                </div>

                <div class="edit-profile-form__item-container">
                    <label for="profileImage">Foto de Perfil</label>
                    <input class="twitter-input" type="file" id="profileImage" name="profileImage">
                </div>

                <div class="edit-profile-form__item-container">
                    <label for="bio">Biografía</label>
                    <textarea class="twitter-input" id="bio" name="bio" rows="4" cols="50"><?= $page_data['user_data']['bio'] ?></textarea>
                </div>
